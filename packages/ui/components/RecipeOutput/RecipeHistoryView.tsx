...
import { RecipeTemplateFragment, RequestHeader } from "types/database";
...
function HistoryActions({
  ...
  const onSubmit = (action: "save" | "preview") => {
    ...
    const urlPaths = requestInfo.url.split("?")[0].split("/");
    const recipeURLPaths = editorURL.split("?")[0].split("/");
